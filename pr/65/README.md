...
- [Postprocess Filter Tuner](postprocess-filter-tuner/) <a href="postprocess-filter-tuner/README" class="readme-badge">[README]</a><br><span class="vibe-desc">Tune sleap-nn post-inference FilterConfig knobs against ground truth, visualize the bad-removed vs. good-lost tradeoff, and export the config</span>
