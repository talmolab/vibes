...
- [Salk Email Signature](salk-signature/) <a href="salk-signature/README" class="readme-badge">[README]</a><br><span class="vibe-desc">Generate a branded Salk email signature with live preview and one-click rich-HTML copy for Outlook, Apple Mail, and Gmail</span>
