...
- [Camera Comparison](camera-comparison/) <a href="camera-comparison/README" class="readme-badge">[README]</a><br><span class="vibe-desc">Compare lab cameras (DJI/GoPro/Basler) with interactive FOV calculator, setup wizard, and multi-cam planner</span>
