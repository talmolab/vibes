...
- [Hand Dissection Lab](hand-dissection-lab/) <a href="hand-dissection-lab/README" class="readme-badge">[README]</a><br><span class="vibe-desc">Run MediaPipe's hand landmark network standalone in TensorFlow.js: explore its 45 internal layers, read live speed/angle features off the hand, and compare a hand-crafted pose subspace against the network's learned 768-d embedding</span>
...
- [md](md/) <a href="md/README" class="readme-badge">[README]</a><br><span class="vibe-desc">Append any public markdown URL (Google Drive, GitHub, gists, GitLab, Docs) to the viewer URL and read it rendered — shareable links with no build step</span>
